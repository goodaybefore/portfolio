...
CREATE TABLE `trip` (
  ...
  KEY `FK_small_category_TO_trip_1` (`tr_ca_num`),
  ...
  CONSTRAINT `FK_small_category_TO_trip_1` FOREIGN KEY (`tr_ca_num`) REFERENCES `small_category` (`sc_num`),

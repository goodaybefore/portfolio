...
CREATE TABLE `member_image` (
  ...
  `mi_me_id` varchar(20) NOT NULL,
  `mi_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`mi_num`),
  KEY `FK_member_TO_member_image_1` (`mi_me_id`),
  CONSTRAINT `FK_member_TO_member_image_1` FOREIGN KEY (`mi_me_id`) REFERENCES `member` (`me_id`)

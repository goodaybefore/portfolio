            ...
            <div class="container">
            	...
            	<div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="me_pw" id="password" placeholder="Your Password"/>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="me_name" id="name" placeholder="Your Name"/>
                        </div>
                        <div class="form-group">
